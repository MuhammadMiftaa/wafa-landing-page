      ...
      <div className="page-wrap">
        ...
        <div className="mb-10">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link
              to="/blog"
              className="flex items-center gap-1 text-xs font-semibold no-underline hover:text-[var(--magenta-bold)] transition-colors"
              style={{
          ...
          <div className="grid sm:grid-cols-3 gap-5 scroll-x sm:overflow-visible flex-nowrap p-5">
            {risalah.map((article) => {
              ...
              return (
                ...
                >
                  <div
                    className="rounded-3xl overflow-hidden transition-all card-hover h-full"
                    style={{
                      background: "white",
                  ...
                  >
                    ...
                    <div className="p-5">
                      <span
                        className="inline-block text-[10px] font-bold rounded-full px-2.5 py-0.5 mb-2"
                        style={{
                          background: cat.bg,
                          color: cat.color,
                          fontFamily: "var(--font-heading)",
                      ...
                      <h4
                        className="font-bold text-sm leading-snug mb-2 group-hover:text-[var(--magenta-bold)] transition-colors"
                        style={{
                          fontFamily: "var(--font-heading)",
                          color: "var(--text-primary)",
                        }}
        ...
        <div className="mb-10">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link
              to="/blog"
              className="flex items-center gap-1 text-xs font-semibold no-underline transition-colors hover:text-[var(--magenta-bold)]"
              style={{
                color: "var(--text-secondary)",
                fontFamily: "var(--font-heading)",
              }}
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h4
                      className="font-semibold text-sm leading-snug mb-1 group-hover:text-[var(--magenta-bold)] transition-colors"
                      style={{
                        fontFamily: "var(--font-heading)",
                        color: "var(--text-primary)",
                      }}
        ...
        <div>
              ...
              >
                <div
                  ...
                  style={{
                    height: "120px",
                    background:
                      "linear-gradient(135deg, rgba(255,0,0,0.08), rgba(255,0,0,0.04))",
                  }}
                >
          ...
          <div className="text-center mt-5">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex scale-100 items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white no-underline transition-all hover:scale-105"
              style={{
                background: "#FF0000",
                fontFamily: "var(--font-heading)",
