...
export function FinalCTASection() {
  return (
    <section
      ...
      style={{ background: 'linear-gradient(180deg, rgba(75,42,103,0.03) 0%, rgba(209,0,113,0.02) 100%)' }}
    >
      <div className="page-wrap">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(209,0,113,0.06), rgba(157,22,124,0.04))',
          ...
          >
            <div
              ...
              style={{ background: 'linear-gradient(135deg, var(--magenta-bold), var(--magenta-deep))', boxShadow: '0 8px 24px rgba(209,0,113,0.35)' }}
            >
            ...
            <p className="text-sm leading-relaxed mb-6 flex-1" style={{ color: 'var(--text-secondary)' }}>
              ...
              Audio makhraj interaktif, irama Hijaz, dan quiz-game seru dalam satu aplikasi.
            </p>
          ...
          <div
            className="rounded-3xl p-8 flex flex-col transition-all card-hover"
            style={{
              background: 'linear-gradient(135deg, rgba(31,129,36,0.06), rgba(73,216,80,0.03))',
          ...
          >
            <div
              className="flex h-14 w-14 items-center justify-center rounded-2xl text-white mb-5"
              style={{ background: 'linear-gradient(135deg, var(--emerald), var(--fresh))', boxShadow: '0 8px 24px rgba(31,129,36,0.35)' }}
            >
            ...
            <p className="text-sm leading-relaxed mb-6 flex-1" style={{ color: 'var(--text-secondary)' }}>
              Dapatkan pendampingan implementasi 7M, standarisasi guru, supervisi berkala,
              dan program lengkap untuk meningkatkan mutu pembelajaran Al-Qur'an di lembaga Anda.
            </p>
            <div className="space-y-3">
              <a
                ...
                style={{
                  ...
                  background: 'linear-gradient(135deg, var(--emerald), var(--fresh))',
